...
function target_policy(state, params)
    ...
    # A positive body-frame bearing produces a positive mean tail tangent. The
    # bias is bounded and fades inside the final body length, where bearing is
    # poorly conditioned and the first-crossing capture will terminate anyway.
