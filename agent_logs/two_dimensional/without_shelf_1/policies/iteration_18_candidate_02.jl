function target_policy_params()
    return (
        ...
        acceleration_command_limit=1575.0 * pi / 180,
    )
end
...
function target_policy(state, params)
    ...
    # sampled static anchor. The slightly reduced command ceiling is the sole
    # effort probe; it does not alter route feedback or desired joint angles.
