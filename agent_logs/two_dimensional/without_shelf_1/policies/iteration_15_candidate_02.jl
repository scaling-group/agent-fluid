function target_policy_params()
    return (
        ...
        steering_opposition_boost=0.75,
...
function target_policy(state, params)
    ...
    # unchanged. The isolated capture-directed continuation keeps phase gain
    # in [1, 1.75] and cannot attenuate the sampled static anchor.
