...
function target_policy(state, params)
    ...
    # Preserve the sampled bearing and direct-body-rate anchor. Test one small
    # increase in the successful bounded cross-track request to tighten the
    # broad far-field diagonal approach without changing propulsion or phase.
