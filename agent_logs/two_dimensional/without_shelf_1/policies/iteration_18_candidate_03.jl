...
function target_policy(state, params)
    ...
    # Preserve the sampled bearing and direct-body-rate anchor. The bounded
    # body-frame cross-track request corrects a large lateral miss before
    # angular bearing grows near a streamwise pass.
