...
function target_policy(state, params)
    ...
    # Bracket the sampled heading-rate optimum without allowing the rate term
    # to reverse a saturated positive bearing request. Direct body rotation is
    # retained because target-bearing-rate variants mixed rotation with target
    # translation and lost upstream progress.
