function target_policy_params()
    return (
        ...
        acceleration_command_limit=1550.0 * pi / 180,
    )
end
...
function target_policy(state, params)
    ...
    # Isolate a modest command-ceiling bracket on the reproduced arrival
    # controller; every propulsion and navigation request above is unchanged.
