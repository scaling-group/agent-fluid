...
function target_policy(state, params)
    ...
    # Keep the evidence-backed positive bearing sign, but damp body rotation
    # directly. Bearing-window rate mixed translation with rotation and did
    # not prevent the sampled broad loop; normalized heading rate isolates the
    # rotational overshoot that should release posterior steering authority.
