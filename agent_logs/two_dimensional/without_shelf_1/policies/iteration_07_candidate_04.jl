...
function target_policy(state, params)
    ...
    # Keep the evidence-backed positive bearing sign and the best sampled
    # damping cap, but make direct body rotation act before the late upward
    # curl develops. The smaller scale changes onset without permitting the
    # rate term to reverse a saturated bearing request, and it cannot react to
    # target translation as the failed bearing-window-rate variants did.
