function target_policy_params()
    return (
        ...
        posterior_target_limit=38.0 * pi / 180,
...
function target_policy(state, params)
    ...
    # Use the sampled best positive bearing and direct body-rate settings. The
    # rate term remains bounded and cannot react to target translation as the
    # failed bearing- and lateral-rate variants did.
    ...
    # posterior tangent q1 + q2. Bound the desired posterior joint before the
    # servo so reinforcing phase lag, anterior cancellation, and steering do
    # not continually request an angle beyond the observed physical envelope.
