function target_policy_params()
    return (
        ...
        steering_opposition_boost=0.55,
...
function target_policy(state, params)
    ...
    # Preserve every phase of the evidence-best static request. Continue the
    # sole sampled positive steering gradient by adding bounded authority only
    # when the posterior target remaining after that request still opposes the
    # steering direction. The extra term uses measured phase headroom instead
    # of driving the joint farther outward.
    ...
    # unchanged. The phase gain is in [1, 1.55] and cannot attenuate the
