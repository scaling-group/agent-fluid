...
function target_policy(state, params)
    ...
    # Keep the evidence-best damping ceiling, which cannot reverse a saturated
    # positive bearing request, but engage it at a smaller body rotation rate.
    # This isolates turn-rate sensitivity without reacting to target-vector
    # translation as the failed bearing-rate variant did.
