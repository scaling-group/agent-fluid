...
function target_policy(state, params)
    ...
    # Restore the evidence-best direct body-rate setting. The only probe
    # relative to that sampled anchor is one degree of additional positive
    # posterior bearing authority; the inherited 8-degree comparison lost
    # upstream progress, while further rate gain/sensitivity tuning regressed.
