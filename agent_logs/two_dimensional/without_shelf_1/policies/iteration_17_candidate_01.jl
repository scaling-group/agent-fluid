...
function target_policy(state, params)
    ...
    # Preserve the successful bearing and direct-body-rate anchor. Add a small,
    # bounded body-frame cross-track request so a large lateral miss starts
    # correcting before angular bearing grows near a streamwise pass.
    ...
    # unchanged. The sampled phase gain remains in [1, 1.50] and cannot
