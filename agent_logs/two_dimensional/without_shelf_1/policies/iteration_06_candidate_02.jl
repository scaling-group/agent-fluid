...
function target_policy(state, params)
    ...
    # rotation enough authority to cross zero and briefly counter-steer after
    # the turn develops. The turn-rate term remains bounded and cannot react
    # to target translation as the failed bearing- and lateral-rate variants
    # did.
