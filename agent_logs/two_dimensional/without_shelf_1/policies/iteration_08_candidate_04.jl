...
function target_policy(state, params)
    ...
    # Preserve the evidence-best direct body-rate feedback while increasing
    # authority only for small and moderate body-frame bearing. The 10 degree
    # ceiling is unchanged, so this does not demand a larger saturated mean
    # bend or react to target translation as failed bearing-rate variants did.
