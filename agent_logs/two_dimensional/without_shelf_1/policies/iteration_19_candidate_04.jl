function target_policy_params()
    return (
        ...
        acceleration_command_limit=1700.0 * pi / 180,
    )
end
...
function target_policy(state, params)
    ...
    # Isolate a small above-anchor authority bracket. The inherited lower-cap
    # test lost capture while still saturating angle and rate, so all gait and
    # navigation requests remain unchanged.
