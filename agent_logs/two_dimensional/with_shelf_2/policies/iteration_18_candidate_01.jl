...
function target_policy(state, params)
    ...
    # Use the signed lateral fraction of body motion relative to the target
    # line of sight. It matches angular damping near alignment while smoothly
    # bounding the response to large wake-induced slip.
    lateral_course_error = sin(course_mismatch)
    ...
    predicted_bearing = bearing - heading_response -
        ...
        course_confidence * lateral_course_error
    route_turn = tanh(
