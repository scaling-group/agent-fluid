function target_policy_params()
    return (
        ...
        approach_closure_emphasis=0.20,
...
function target_policy(state, params)
    ...
    # A fast positive approach needs more slip damping than a stall at the
    # same range. Use only normalized positive closure to schedule a modest
    # increase around the validated course residual; reversal never earns
    # extra route authority, and the independently bounded heading forecast
    # remains outside this schedule.
    ...
    approach_closure_scale = 1 +
        params.approach_closure_emphasis * closure_efficiency
    predicted_bearing = bearing - heading_response -
        params.approach_course_damping * approach_closure_scale * approach_gate *
