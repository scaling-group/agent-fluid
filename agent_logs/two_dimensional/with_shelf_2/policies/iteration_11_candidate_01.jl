...
function target_policy(state, params)
    ...
    # observed body-frame bearing magnitude is shrinking or growing. When the
    # wake/body interaction is already producing a large yaw moment, distrust
    # that auxiliary course trend and fall back toward plain positive closure.
    # The base wave, steering residual, and nonzero steering floor are intact.
    ...
    course_consistency_scale = 1 +
        params.course_consistency_modulation * steering_gate *
