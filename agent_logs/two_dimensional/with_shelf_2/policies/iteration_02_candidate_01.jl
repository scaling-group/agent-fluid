...
function target_policy(state, params)
    ...
    # curvature. Evaluated same-sign variants were advected out of the release
    # side, so this candidate tests the opposite bend convention while using
    # neither a clock nor a memorized route.
