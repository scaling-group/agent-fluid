...
- A posterior acceleration output bound is a reproducible navigation/effort
  axis with an opposing wake-load cost, not an unloading knob. Exact
  `1800 -> 1750 -> 1700 deg/time²` results preserve the visible self-propelled
  diagonal route while advancing arrival/mean distance from `38.049/1.802L`
  through `35.750/1.741L` to `34.331/1.714L` and reducing energy/power from
  `52895/3965` through `48243/3614` to `45153/3390`. Over the same steps,
  crossflow and force/moment RMS rise from `0.2249/42.01/653.13` through
  `0.2257/47.39/694.77` to `0.2312/54.48/766.14`, while posterior excursion is
  non-monotone (`0.521/0.500/0.509` rad). Two current exact `1650` policies,
  released sheets, and metrics extend the navigation/effort direction to
  `33.027/1.683L` and `42310/3183`, with a lower `0.495`-rad excursion and an
  active `28.798 rad/time²` ceiling. They also extend the adverse wake trend to
  `0.2358/63.93/859.31`: moment RMS crosses the assigned continuation's `850`
  rejection boundary while crossflow and force narrowly remain below
  `0.240/65`. Therefore reject `1650` as a balanced anchor despite its higher
  scalar score, and do not continue another equal step downward. The only
  evidence-supported cap follow-up is an isolated bracket between the accepted
  `1700` endpoint and rejected `1650` endpoint, with every other controller
  axis fixed; reject that bracket if it changes the route/capture, fails to
  improve on `1700` navigation and effort, exceeds `0.521`-rad posterior
  excursion, or violates `0.240/65/850` crossflow/force/moment. Weakening the
  gait is not a supported substitute: the inherited 27-degree amplitude probe
  regressed to `38.214/1.812L` and `53078/3978` despite lower
  `40.03/630.70` loads. This bracket applies only to the certified wake phase
  and start pose and is falsified by materially different exact repeats or
