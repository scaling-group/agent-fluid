function target_policy_params()
    return (
        ...
        anterior_steering_fraction=0.45,
    )
end
...
function target_policy(state, params)
    ...
    # Preserve the total steering center while assigning its remainder to the
    # posterior joint; the velocity term retains the smooth traveling-bend lag.
