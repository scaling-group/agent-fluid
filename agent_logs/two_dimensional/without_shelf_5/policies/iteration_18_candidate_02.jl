function target_policy_params()
    return (
        ...
        tail_lag_gain=0.75,
        tail_damping=0.65,
        anterior_acceleration_limit=1750.0 * pi / 180,
        posterior_acceleration_limit=1700.0 * pi / 180,
        bearing_limit=pi / 2,
        steering_gain=1.7,
...
function target_policy(state, params)
    ...
    a1 = clamp(
        raw_a1,
        -params.anterior_acceleration_limit,
        params.anterior_acceleration_limit,
    )
    ...
    raw_a2 = omega^2 * (phase_lag_target - q2) - 2 * params.tail_damping * omega * qd2
    a2 = clamp(
        raw_a2,
        -params.posterior_acceleration_limit,
        params.posterior_acceleration_limit,
    )
