...
function target_policy(state, params)
    ...
    # Body-frame bearing supplies the evaluated, bounded curvature center
    # without prescribing a global route; joint state still carries phase.
    ...
    # Center the total posterior tangent on the same steering command while
    # retaining the seed's smooth velocity-dependent traveling-bend lag.
