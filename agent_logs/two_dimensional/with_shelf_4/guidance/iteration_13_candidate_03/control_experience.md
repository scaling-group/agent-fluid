...
- Two later one-change actuator-coordination attempts preserve semantic
  ...
  signature can distinguish useful from adverse load. A torque-response test
  should use normalized body-frame quantities and is falsified unless it
  preserves the `137.357` capture while improving distance and effort/load
  together, not merely retaining success.
