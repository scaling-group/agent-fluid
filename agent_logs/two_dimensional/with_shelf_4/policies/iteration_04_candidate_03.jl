...
function target_policy(state, params)
    ...
    # Persistent body-frame bearing owns the route. A much smaller normalized
    # yaw-load residual trims fast wake disturbances without introducing a
    # static bend, clock, or assumed vortex phase. Positive bend produces the
    # negative-yaw response needed to oppose positive applied moment here.
