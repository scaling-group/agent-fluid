...
function target_policy(state, params)
    ...
    # rather than sending every near-limit acceleration change directly to the
    # joint integrator. Use the observed applied action and actual normalized
    # observation interval, so this adds neither a clock nor mutable state and
    # keeps the same response time when the CFD timestep changes.
