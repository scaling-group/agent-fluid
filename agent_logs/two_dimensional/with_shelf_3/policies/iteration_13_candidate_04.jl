...
function target_policy(state, params)
    ...
    # The independently evaluated response-release branch improved arrival and
    # distance integral. Withdraw only part of distributed mean curvature once
    # a developed gait is rotating targetward and body-frame bearing shrinks;
    # this path can neither add steering nor attenuate the traveling rhythm.
    ...
    # The independently evaluated headroom branch reduced loads while retaining
    # capture. Permit yielding only during coherent closure and only when
    # observed posterior motion reinforces the optional turn-congruent residual.
