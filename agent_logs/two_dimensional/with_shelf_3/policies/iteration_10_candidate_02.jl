...
function target_policy(state, params)
    ...
    # Yield only the incremental posterior asymmetry when observed posterior
    # motion already reinforces it near the gait's own state scales. The base
    # lagged traveling wave and target-signed mean curvature remain untouched.
