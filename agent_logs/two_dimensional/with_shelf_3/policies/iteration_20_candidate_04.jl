...
function target_policy(state, params)
    ...
    # turn is hydrodynamic assistance, not an error to cancel. Fuse these two
    # positive, normalized components with a bounded soft union: either cue is
    # preserved when acting alone, while simultaneous translation and rotation
    # smoothly strengthen the evidence for yielding optional posterior effort.
