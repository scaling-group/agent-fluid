...
function target_policy(state, params)
    ...
    # Preserve the sampled rhythm, steering direction, and steering ceiling
    # that produced the strongest finite upstream motion. Midpoint turn damping
    # tests the direct bracket between its upper exit and the inherited lower
    # exit without adding a range gate or changing the propulsion oscillator.
    steering_request =
