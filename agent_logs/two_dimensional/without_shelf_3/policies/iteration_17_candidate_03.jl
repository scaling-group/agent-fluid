function target_policy_params()
    return (
        ...
        terminal_posterior_steering_fraction=0.55,
...
function target_policy(state, params)
    ...
    # The sampled partial anterior unload outperformed both no unload and full
    # unload. Keep that interior allocation, then use the same strict terminal
    # gate to test a small posterior redistribution without touching the
    # demonstrated closing leg.
