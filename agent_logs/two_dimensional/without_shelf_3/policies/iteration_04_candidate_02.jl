...
function target_policy(state, params)
    ...
    # Preserve the only sampled steering sign that produced active upstream
    # motion, but grade curvature over a radian-scale bearing error. Opposing
    # measured yaw unloads the command during the sampled large curling turn.
    steering_request = params.steering_gain * state.bearing -
    ...
    # the sampled full phase-radius regulators were finite but lost propulsion.
