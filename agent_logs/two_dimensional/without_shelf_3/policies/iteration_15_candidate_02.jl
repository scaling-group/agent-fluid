function target_policy_params()
    return (
        ...
        behind_bearing_fraction=-0.15625,
...
function target_policy(state, params)
    ...
    # response is non-monotone, so use a bounded interior fraction of the
    # evaluated -0.125 to -0.25 tradeoff once the target passes abeam.
