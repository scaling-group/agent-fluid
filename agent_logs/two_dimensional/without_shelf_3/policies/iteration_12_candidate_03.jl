...
function target_policy(state, params)
    ...
    # Preserve the sampled progress gait while the target is ahead. After the
    # target passes abeam, remove the aliased bearing term and ramp in bounded
    # turn damping so the terminal heading has an active straightening term.
