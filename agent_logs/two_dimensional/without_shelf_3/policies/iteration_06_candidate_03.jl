...
function target_policy(state, params)
    ...
    # Preserve the sampled rhythm, steering direction, and fixed turn damping
    # that produced the strongest finite upstream motion. The lower saturation
    # ceiling changes only large-error mean curvature, where the keyframes show
    # the broad late turn, while retaining small-bearing course correction.
    steering_request =
