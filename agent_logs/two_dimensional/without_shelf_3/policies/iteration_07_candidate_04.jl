...
function target_policy(state, params)
    ...
    # Interpolate uniformly inside the observed sharp course boundary: 0.04
    # retained upstream propulsion but exited above, while 0.05 reversed into
    # a lower flow-following exit. The sampled distance gate was also worse.
    steering_request =
