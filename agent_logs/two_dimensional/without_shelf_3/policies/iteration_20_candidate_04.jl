function target_policy_params()
    return (
        ...
        terminal_steering_fraction=0.25,
...
function target_policy(state, params)
    ...
    # Absolute-bearing rolloff damaged the approach when active globally.
    # Apply the same bounded residual-authority scale only after the target is
    # deeply rearward and both distance trends confirm course loss. This keeps
    # the evaluated closing law exact while removing most terminal mean bend.
