...
function target_policy(state, params)
    ...
    # Full neutralization repeated the same terminal upper return. Cross the
    # neutral point only inside the strict recovery gate to test bounded
    # anterior counter-curvature, while preserving posterior allocation and
    # the propulsion-producing traveling bend.
