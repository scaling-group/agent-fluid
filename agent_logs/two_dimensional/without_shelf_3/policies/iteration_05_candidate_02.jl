...
function target_policy(state, params)
    ...
    # Preserve the strongest finite controller's bearing law while testing a
    # single increase in opposing yaw damping to arrest its late broad turn.
    steering_request =
    ...
    # Preserve the demonstrated local guards so this candidate isolates the
    # turn-rate gain instead of changing propulsion protection simultaneously.
    ...
    # Smoothly keep policy demand below the evaluator's hard envelope.
