function target_policy_params()
    return (
        ...
        terminal_posterior_steering_fraction=0.75,
...
function target_policy(state, params)
    ...
    # The sampled dual-opening gate preserved the closing leg. Require deep
    # rearward geometry and opening on both measured scales before changing
    # terminal joint allocation.
    ...
    # Partial anterior unloading outperformed complete unloading. An inherited
    # posterior attenuation test was worse still, so preserve the anterior
    # anchor and test the opposite side of posterior allocation only inside the
    # strict terminal gate.
