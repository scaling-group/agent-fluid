function target_policy_params()
    return (
        ...
        anterior_steering_fraction=0.30,
...
function target_policy(state, params)
    ...
    # Preserve the sampled steering law that produced active upstream motion;
    # nearby turn-rate gains and lateral damping shortened that useful leg.
    steering_request =
    ...
    # Shift a small share of mean curvature posteriorly while retaining the
    # velocity-dependent traveling lag that supplied the upstream body wave.
    # This is the sole control change from the strongest finite anchor.
