...
function target_policy(state, params)
    ...
    # Preserve the strongest finite sample's gait and bearing law. Doubling
    # only its opposing yaw term tests the broad late turn seen at 0.04.
    steering_request =
    ...
    # Keep the evidenced angle-only drive around the moving equilibrium; the
    ...
    # velocity-dependent traveling lag that supplied active upstream motion.
