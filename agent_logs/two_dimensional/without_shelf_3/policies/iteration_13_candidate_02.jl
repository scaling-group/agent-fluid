...
function target_policy(state, params)
    ...
    # Preserve the strongest finite target-ahead controller exactly. The
    # compact bearing aliases ahead and behind, so reverse half of its authority
    # only after the signed body-frame target projection crosses the beam.
