function target_policy_params()
    return (
        ...
        approach_turn_damping_boost=0.02,
...
function target_policy(state, params)
    ...
    # Preserve the best finite sample's far-field turn damping. Increase it
    # smoothly only inside the range where that rollout began its late loop;
    # the total remains well below the failed uniform 0.10 gain.
    ...
    turn_damping = params.turn_rate_damping_gain +
        params.approach_turn_damping_boost * approach_gate
    steering_request =
