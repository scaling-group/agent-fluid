...
function target_policy(state, params)
    ...
    # Positive bearing bias visibly produces negative heading rotation in the
    # sampled upper turn. Add the signed heading rate so that this negative
    # response reduces, rather than reinforces, the steering request.
    steering_request =
