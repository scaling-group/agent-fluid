...
function target_policy(state, params)
    ...
    # Interpolate the sampled yaw-damping bracket: 0.04 turned upward, while
    # the otherwise identical 0.06 policy overcorrected downward and downstream.
    steering_request =
    ...
    # Preserve the strongest finite policy's localized joint-state guards so
    # this candidate isolates the course-damping interpolation.
