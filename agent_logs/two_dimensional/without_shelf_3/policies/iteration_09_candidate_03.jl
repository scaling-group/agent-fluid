...
function target_policy(state, params)
    ...
    # active upstream motion. The sole control change steps just below the
    # 0.04 damping anchor after three larger gains shortened its upstream leg.
    steering_request =
