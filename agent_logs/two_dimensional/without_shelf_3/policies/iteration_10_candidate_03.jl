...
function target_policy(state, params)
    ...
    # Bound target-relative steering and oppose rapid recent turns.
    steering_request =
    ...
    # Preserve total mean curvature while placing more of its bias posteriorly.
    ...
    # Local guards oppose high-angle and high-speed joint excursions.
