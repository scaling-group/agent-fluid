...
function target_policy(state, params)
    ...
    # Preserve the best sampled target-ahead law. After the target passes the
    # beam, continue the only sampled terminal change that improved progress:
    # reverse a bounded fraction of the demonstrated bearing contribution.
