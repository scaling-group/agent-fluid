...
function target_policy(state, params)
    ...
    # Preserve the strongest finite sample's bearing law and fixed turn
    # damping; ceiling, damping, and large-bearing shaping descendants all
    # shortened its upstream leg while repeating the upper U-turn.
    steering_request =
    ...
    # Keep total commanded curvature unchanged while moving one tenth of the
    # steering equilibrium aft to reduce anterior whole-body turning leverage.
