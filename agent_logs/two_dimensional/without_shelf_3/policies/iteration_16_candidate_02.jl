...
function target_policy(state, params)
    ...
    # the observation window before unloading anterior mean curvature.
    ...
    # The sampled partial unload improved navigation and reduced anterior
    # excursion. Test full neutralization only inside the same terminal gate;
    # preserve posterior allocation and the propulsion-producing body wave.
