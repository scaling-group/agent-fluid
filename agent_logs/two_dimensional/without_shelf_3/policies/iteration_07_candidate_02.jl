...
function target_policy(state, params)
    ...
    # Restore the strongest finite sample's gait and fixed turn damping. The
    # sole experimental change is a higher saturation ceiling: small bearing
    # requests remain nearly linear, while large late course errors retain
    # more target-relative steering authority than the failed 10 deg variant.
    steering_request =
    ...
    # Preserve the local guards that kept the strongest approach finite while
    # opposing the high-angle/high-speed route to cap contact and body folding.
