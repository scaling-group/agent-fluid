...
function target_policy(state, params)
    ...
    # Retain the sampled anchor's bounded bearing/rate response. Both evaluated
    # schedules improved the fixed endpoints: recover with 0.08 while receding
    # or under strong target-away drift, then ease toward 0.07 otherwise.
    bearing_rate = clamp(
