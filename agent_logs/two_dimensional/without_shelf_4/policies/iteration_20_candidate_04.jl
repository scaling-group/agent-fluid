function target_policy_params()
    return (
        ...
        away_drift_activation_fraction=0.75,
...
function target_policy(state, params)
    ...
    # Retain the sampled anchor's bounded bearing/rate response and symmetric
    # rolling-progress selector. Engage its existing target-away correction
    # somewhat earlier without changing its sign gate or maximum lookahead.
    bearing_rate = clamp(
    ...
    away_drift_scale = params.away_drift_activation_fraction *
