...
function target_policy(state, params)
    ...
    # Preserve the sampled bearing lookahead, but separate its target-line and
    # body-rotation components. A small additional heading-rate term damps
    # rotation without weakening target-line motion anticipation.
    bearing_rate = clamp(
    ...
    predicted_bearing = state.bearing +
                        ...
                        params.heading_rate_lead * heading_rate
