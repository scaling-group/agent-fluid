...
function target_policy(state, params)
    ...
    # Preserve the successful bounded posterior steering sign. A modestly
    # longer clipped rate lead asks broad turns to unwind before alignment
    # while leaving the far-off-axis steering limit unchanged.
    bearing_rate = clamp(
