function target_policy_params()
    return (
        ...
        lateral_velocity_lookahead=0.075,
...
function target_policy(state, params)
    ...
    # Retain the sampled anchor's bounded bearing/rate response. Add only a
    # small counter-drift correction while body-frame lateral translation is
    # directed away from the target. The one-sided 0.075 refinement retreats
    # slightly from the sampled 0.08 gain after 0.10 regressed the route;
