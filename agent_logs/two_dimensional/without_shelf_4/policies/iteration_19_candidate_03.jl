function target_policy_params()
    return (
        ...
        closing_speed_scale_closing=0.020,
        closing_speed_scale_receding=0.015,
...
function target_policy(state, params)
    ...
    # Keep the score-leading selector purely on rolling distance progress.
    # Preserve the sharper recovery branch that the inherited sign split
    # showed is needed for route quality, while isolating a gentler transition
    # after closing resumes.
    bearing_rate = clamp(
