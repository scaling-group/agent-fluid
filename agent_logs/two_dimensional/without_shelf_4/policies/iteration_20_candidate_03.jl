function target_policy_params()
    return (
        ...
        lateral_velocity_lookahead_min=0.069,
...
function target_policy(state, params)
    ...
    # Keep the reproduced symmetric progress transition. Both asymmetric
    # 0.020 splits regressed, so isolate a slightly lower closing endpoint
    # while preserving the 0.080 recovery endpoint and selector timing.
    bearing_rate = clamp(
