...
function target_policy(state, params)
    ...
    # oscillator on a bounded phase-space energy shell. This sampled 20-degree
    # shell supplied target-reaching upstream authority without hard-cap contact.
    ...
    # The slightly sharper scale tests earlier corridor alignment without
    # raising the steering limit or propulsion-shell acceleration.
    bearing_rate = clamp(
    ...
    # guard sits above the nominal anterior scale and should not define the gait.
