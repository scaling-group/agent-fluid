...
function target_policy(state, params)
    ...
    # Retain the sampled anchor's bounded bearing/rate response. Probe midway
    # between the evaluated 0.07 score/mean-distance endpoint and the 0.08
    # arrival/load endpoint; targetward translation stays exactly on-anchor.
    bearing_rate = clamp(
