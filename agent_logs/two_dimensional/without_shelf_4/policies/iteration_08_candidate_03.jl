...
function target_policy(state, params)
    ...
    # Retain a short, bounded bearing lookahead, but back off the rate term from
    # the sampled anchor after greater lookahead delayed corridor acquisition.
    # This uses no coordinates, route, or external phase clock.
    bearing_rate = clamp(
