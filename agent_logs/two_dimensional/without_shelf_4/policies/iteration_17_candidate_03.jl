...
function target_policy(state, params)
    ...
    # rolling-progress selector. Continue half of the successful 0.020-to-0.015
    # scale reduction so recovery selects 0.08 more decisively while receding
    # and 0.07 while closing, without changing the evaluated endpoints.
    bearing_rate = clamp(
