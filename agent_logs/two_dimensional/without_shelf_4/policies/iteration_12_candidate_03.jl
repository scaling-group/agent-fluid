...
function target_policy(state, params)
    ...
    # shell retained capture and stays just below the local acceleration guard.
    ...
    # Preserve the demonstrated bearing/rate response. Strengthen only the
    # sampled counter-drift term while body-frame lateral translation is away
    # from the target; stationary and targetward translation stay on-anchor.
    bearing_rate = clamp(
    ...
    # bend while the anterior propulsion shell remains symmetric.
