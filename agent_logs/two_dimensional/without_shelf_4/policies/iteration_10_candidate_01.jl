...
function target_policy(state, params)
    ...
    # Keep propulsion phase independent of steering. Three sampled 20.25-degree
    # sheets reproduced an earlier capture than the assigned 20-degree parent.
    ...
    # above the replicated 31.055 maximum and below the episode hard envelope.
