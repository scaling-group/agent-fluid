...
function target_policy(state, params)
    ...
    # strong target-away drift receives the successful upper value while weak
    # drift tapers toward the lower value. Targetward translation stays on the
    # anchor exactly.
    bearing_rate = clamp(
    ...
    lateral_velocity_lookahead = params.lateral_velocity_lookahead_min +
                                 (params.lateral_velocity_lookahead_max -
                                  params.lateral_velocity_lookahead_min) *
                                 away_drift_weight
