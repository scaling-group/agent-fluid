...
function target_policy(state, params)
    ...
    # Keep the score-leading selector purely on rolling distance progress and
    # sign-symmetric. Both inherited one-sided relaxations lost route quality,
    # so test only a modest sharpening of the replicated 0.015 transition.
    bearing_rate = clamp(
