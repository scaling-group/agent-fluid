...
function target_policy(state, params)
    ...
    # Keep the demonstrated static bearing response while testing less rate
    # anticipation. The sampled 0.30 lead produced premature zig-zag reversals;
    # this isolated 0.20 probe leaves propulsion and static gain unchanged.
    bearing_rate = clamp(
