...
function target_policy(state, params)
    ...
    # Retain the sampled anchor's bounded bearing/rate response. Never weaken
    # its recovery lookahead while distance progress is lost; admit the
    # faster, lower-load drift schedule only when it asks for more correction.
    bearing_rate = clamp(
