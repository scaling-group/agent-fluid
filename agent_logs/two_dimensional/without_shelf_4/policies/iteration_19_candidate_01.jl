function target_policy_params()
    return (
        ...
        closing_speed_scale_closing=0.0125,
...
function target_policy(state, params)
    ...
    # Keep the selector purely on rolling distance progress. Isolate the
    # untested half of the failed symmetric 0.0125 probe: sharpen selection
    # only while closing, but retain the replicated 0.015 recovery response.
    bearing_rate = clamp(
