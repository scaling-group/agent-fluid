...
function target_policy(state, params)
    ...
    # Retain the sampled anchor's bounded bearing/rate response. Use the
    # independently replicated score-oriented lower bracket only while
    # body-frame lateral translation is directed away from the target;
