...
function target_policy(state, params)
    ...
    # Bracket the replicated 0.015 anchor with one modestly sharper transition
    # inside the evaluated 0.07--0.08 envelope: recover with 0.08 while
    # receding, then ease toward 0.07 while closing. Targetward translation
    # stays on-anchor.
    bearing_rate = clamp(
