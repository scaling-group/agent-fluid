...
function target_policy(state, params)
    ...
    # Retain the sampled anchor's bounded bearing/rate response. Modestly
    # exploit the evidence-positive counter-drift correction while body-frame
    # lateral translation is directed away from the target; targetward
    # translation stays on-anchor.
    bearing_rate = clamp(
