...
function target_policy(state, params)
    ...
    # Preserve the anterior authority of the compact anchor. Interpolate only
    # the posterior burst guard between the finite 28 and 27 evaluations,
    # which traded faster closure against slightly tighter mean distance.
