...
function target_policy(state, params)
    ...
    # Use the sampled 0.70 posterior share: it retained compact capture while
    # reducing mean distance, crossflow, and load relative to the 0.65 parent.
    # Propulsive orbit, anterior steering, lag, and damping remain unchanged.
