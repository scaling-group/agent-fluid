function target_policy_params()
    return (
        ...
        oscillator_energy_gain_deficit=2.05,
        oscillator_energy_gain_excess=2.1,
        steering_gain=0.75,
...
function target_policy(state, params)
    ...
    # Limit energy injection to the faster, lower-load evaluated gain while
    # retaining the compact anchor's stronger damping of excess energy. The
    # drive is continuous at the regime boundary because its error is zero.
