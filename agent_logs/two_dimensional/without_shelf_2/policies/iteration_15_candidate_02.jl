...
function target_policy(state, params)
    ...
    # Use the exactly evaluated posterior share of the already bounded bearing
    # curvature; it improved closure without changing the propulsive orbit,
    # anterior steering, lag, damping, or command authority.
