...
function target_policy(state, params)
    ...
    # Use the directly evaluated interior positive-bearing response. Both the
    # 0.745 and 0.77 gain probes took longer routes under the common prewarm.
    ...
    # low-frequency steering curvature with the posterior joint. Slightly more
    # posterior damping targets tail speed without changing the proven guard.
