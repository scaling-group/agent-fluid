...
function target_policy(state, params)
    ...
    # low-frequency steering curvature with the posterior joint. The modest
    # posterior damping increase probes tail-speed/load regulation without
    # changing the anchor's gait, steering, or available tracking authority.
