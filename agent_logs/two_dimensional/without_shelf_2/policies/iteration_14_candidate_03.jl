...
function target_policy(state, params)
    ...
    # Use one static recovery gain midway between the evaluated 2.05 and 2.1
    # endpoints. This avoids the deeper route selected by gain-regime switching
    # while narrowly probing the observed closure-versus-load tradeoff.
