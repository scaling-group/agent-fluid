...
function target_policy(state, params)
    ...
    # Use the replicated 0.70 posterior share: it improves mean distance,
    # crossflow, and load over 0.65, while the inherited 0.75 continuation
    # takes a lower route and loses compact closure. Propulsion is unchanged.
    ...
    # Retain the reproducible common guard so posterior sharing is the only
    # executable change from the prefilled 0.65 controller.
