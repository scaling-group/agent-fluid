...
function target_policy(state, params)
    ...
    # Preserve the evaluated orbit and frequency while continuing the one
    # isolated gain direction that tightened the compact target approach.
