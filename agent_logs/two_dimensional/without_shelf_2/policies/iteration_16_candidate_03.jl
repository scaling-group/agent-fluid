...
function target_policy(state, params)
    ...
    # Continue posterior sharing by one isolated equal step to test whether the
    # 0.70 closure/load benefit persists past its small speed/effort tradeoff.
    # The steering center keeps the added mean-curvature target bounded while
    # the propulsive orbit, lag, and damping remain unchanged.
    ...
    # Retain the reproducible common command guard so this probe isolates only
    # posterior curvature sharing.
