...
function target_policy(state, params)
    ...
    # the mean curvature. Slightly reduce only the quadrature target term to
    # probe posterior response without damping velocity or withholding the
    # anchor's acceleration authority.
