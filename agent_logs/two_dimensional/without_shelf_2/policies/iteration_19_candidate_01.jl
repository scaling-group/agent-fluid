...
function target_policy(state, params)
    ...
    # Add the independently evaluated normalized high-speed gate to the
    # assigned steering-demand schedule. It leaves low/mid-speed damping at
    # the base value and smoothly self-limits as posterior speed is trimmed.
    ...
    # Retain the reproducible common guard; static authority changes selected
    # less compact and more highly loaded routes in inherited evaluations.
