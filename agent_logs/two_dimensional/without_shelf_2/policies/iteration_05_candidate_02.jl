...
function target_policy(state, params)
    ...
    # Probe just above the best sampled positive-bearing response while
    # retaining its 10 degree bend bound. The failed window-rate lead and the
    # higher-load 11 degree variant are intentionally excluded.
