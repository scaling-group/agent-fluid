...
function target_policy(state, params)
    ...
    # Preserve the nominal orbit while bracketing the sampled closure benefit
    # and load cost of stronger wake-displacement recovery, without a clock.
