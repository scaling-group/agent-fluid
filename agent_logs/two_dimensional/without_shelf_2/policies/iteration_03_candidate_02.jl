...
function target_policy(state, params)
    ...
    # Preserve the successful positive-bearing steering sign, but give the
    # bounded response modestly more authority to shorten the observed broad
    # below-target loop without letting steering consume the propulsive bend.
