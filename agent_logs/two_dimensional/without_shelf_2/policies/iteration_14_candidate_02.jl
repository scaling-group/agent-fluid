...
function target_policy(state, params)
    ...
    # Increase only posterior sharing of the already bounded bearing curvature
    # to tighten the anchor's late lower-to-target correction. Propulsive orbit,
    # anterior steering, lag, damping, and command guards remain unchanged.
