...
function target_policy(state, params)
    ...
    # The sampled 0.70/10-degree response shortened capture and tightened the
    # route while remaining finite. Keep that observed bound rather than
    # extrapolating authority or adding the failed bearing-rate lead.
