...
function target_policy(state, params)
    ...
    # Probe one equal posterior-sharing step beyond the replicated 0.70 anchor.
    # The bounded steering center limits the added mean-curvature target while
    # the propulsive orbit, lag, damping, and command authority stay unchanged.
