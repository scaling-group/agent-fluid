...
function target_policy(state, params)
    ...
    # Probe just below the best sampled positive-bearing response after the
    # otherwise identical 0.77 gain regressed. Retain the evaluated 10 degree
    # bend bound and exclude the failed window-rate lead.
