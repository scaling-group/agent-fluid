...
function target_policy(state, params)
    ...
    # Adopt the evaluated posterior share that preserved compact capture while
    # reducing crossflow, joint-speed peaks, and force/moment loads. Propulsive
    # orbit, anterior steering, lag, damping, and command guards stay fixed.
