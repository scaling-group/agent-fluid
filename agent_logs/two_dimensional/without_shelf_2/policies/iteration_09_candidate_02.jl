function target_policy_params()
    return (
        ...
        posterior_acceleration_limit=27.5,
    )
end
...
function target_policy(state, params)
    ...
    # Preserve the anchor's anterior authority. Probe halfway between its
    # posterior guard and the score-favored but slower 27 rad/time^2 result.
