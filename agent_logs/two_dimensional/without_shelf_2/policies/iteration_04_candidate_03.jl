...
function target_policy(state, params)
    ...
    # Use only the evaluated successful positive-bearing curvature sign. The
    # slightly stronger smooth static response targets the remaining early
    # detour without reintroducing the failed bearing-rate turn reversal.
    ...
    # the candidate-owned bound demonstrated by both successful anchors.
