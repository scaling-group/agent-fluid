...
function target_policy(state, params)
    ...
    # Continue the isolated posterior-share response by one equal bounded
    # step. At the steering cap this adds only 0.5 deg of posterior curvature;
    # propulsion, anterior steering, lag, and damping remain unchanged.
    ...
    # executable change from the assigned 0.70 parent.
