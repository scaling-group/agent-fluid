...
function target_policy(state, params)
    ...
    # Preserve the anchor's unit-energy gait while softening only recovery from
    # release and wake-induced energy error. Guard interpolation produced
    # nonlinear route switches, so transient pumping is isolated instead.
    ...
    # Restore the common guard demonstrated by the compact physical anchor;
    # both lower posterior limits and higher global authority regressed.
