...
function target_policy(state, params)
    ...
    # Continue the isolated successful increase in posterior sharing by one
    # equal step. The bounded steering center limits the added mean-curvature
    # target while the propulsive orbit, lag, and damping remain unchanged.
