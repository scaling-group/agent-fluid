...
function target_policy(state, params)
    ...
    # Preserve the successful positive-bearing sign and tested 10 degree
    # curvature envelope. Increase only the smooth response inside that bound;
    # the sampled windowed bearing-rate lead is intentionally excluded.
