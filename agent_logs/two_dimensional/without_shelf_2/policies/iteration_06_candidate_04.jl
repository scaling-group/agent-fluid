...
function target_policy(state, params)
    ...
    # Gain-only samples at 0.70, 0.75, and 0.77 bracket a local interior
    # response near 0.745. Keep the evaluated 10 degree curvature bound and
    # exclude the inherited failed bearing-rate lead.
