...
function target_policy(state, params)
    ...
    # Oppose and lag only the oscillatory component. A modest increase in mean
    # curvature sharing tests whether posterior under-response caused the deep
    # lower corrections in the lower-authority and higher-damping descendants.
