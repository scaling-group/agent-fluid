...
function target_policy(state, params)
    ...
    # Preserve the evaluated posterior share that retained the most compact
    # route. The inherited static increase to 0.75 traded compactness and
    # effort for relative speed and load, so do not interpolate that gain.
