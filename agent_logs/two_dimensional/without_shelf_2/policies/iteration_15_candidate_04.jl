...
function target_policy(state, params)
    ...
    # Preserve the evaluated orbit and frequency while using the replicated
    # restoration gain that tightened the compact target approach. The sampled
    # 2.2 continuation instead slowed capture and increased effort and loads.
    ...
    # Use the evaluated posterior share that tightened target closure while
    # retaining the same bounded anterior bearing map and propulsive orbit.
