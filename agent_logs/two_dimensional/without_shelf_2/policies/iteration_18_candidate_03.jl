...
function target_policy(state, params)
    ...
    # Adopt the replicated 0.70 posterior share: it retained compact capture
    # while reducing mean distance, crossflow, joint-speed peaks, and loads
    # relative to the 0.65 prefill. Do not continue to the regressed 0.75 route.
