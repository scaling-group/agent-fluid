...
function target_policy(state, params)
    ...
    # Preserve the successful carrier wherever commands fit the envelope. Near
    # saturation, reserve a small steering share and fit the carrier plus the
    # remaining residual into the available budget. This keeps direction
    # feedback from being erased by symmetric episode-level hard clipping.
