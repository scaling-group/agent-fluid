...
function target_policy(state, params)
    ...
    # Persistent body-frame target error supplies the mean curvature missing
    # from the propulsive carrier. The bounded residual follows the observed
    # bearing continuously and leaves the oscillator phase in joint state.
