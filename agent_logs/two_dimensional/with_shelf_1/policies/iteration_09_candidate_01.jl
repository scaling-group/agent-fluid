...
function target_policy(state, params)
    ...
    # Move a bounded share of anterior steering toward the observed half-cycle
    # already traveling in the requested turn direction. The posterior joint
    # retains mean steering and its lagged propulsive role instead of receiving
    # a second independent phase gate. Phase comes from state, not a clock.
    ...
    tail_steering = params.tail_steering_ratio * mean_steering
