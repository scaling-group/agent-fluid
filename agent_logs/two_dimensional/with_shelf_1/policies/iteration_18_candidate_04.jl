...
@inline function response_scheduled_asymmetry(
    ...
    # alignment. Relative crossflow is body-fixed and dimensionless; only flow
    # aligned with the requested turn is credited as environmental assistance.
...
function target_policy(state, params)
    ...
    # while targetward relative crossflow and yaw moment are not already
