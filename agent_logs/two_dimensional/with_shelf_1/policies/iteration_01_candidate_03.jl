...
function target_policy(state, params)
    ...
    # A bounded mean-curvature bias turns the traveling bend toward the target.
    # Bearing is dimensionless and body-fixed, so the command follows current
    # target geometry instead of a world-frame route or prescribed turn phase.
