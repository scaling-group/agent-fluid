...
function target_policy(state, params)
    ...
    # fish toward that target. This bounded, dimensionless body-frame slip
    # proxy vanishes continuously when the fish is stationary.
    ...
    # target while measured useful lateral motion damps redundant correction.
    ...
    # Residual direction error temporarily receives more of the fixed command
    # envelope. Scheduling from the slip-corrected error makes that extra share
    # relax when observed motion already supplies the requested course change.
