...
- Localize response feedback to the extra half-cycle burst, and distinguish
  ...
  acceleration limits. Preserve raw-bearing mean steering, reserve, base
  asymmetry, and the carrier; test actuator-local rather than global relief
  next. These implications are limited to the shared prewarm and are falsified
  if a changed wake phase loses capture, reverses the assisting-moment sign, or
  removes the route/load benefit.
