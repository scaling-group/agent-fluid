...
- On the demonstrated bearing-biased carrier, moving posterior steering onto
  ...
  reversal acceleration. For this carrier, preserve full projection-free
  authority at large body-frame error and test rate-direction relief only as
  alignment improves; reject it if the direct route weakens, arrival regresses
  beyond the globally guarded sample, or cap/load evidence does not improve.
