...
function target_policy(state, params)
    ...
    # Preserve the full evaluated redirect at large body-frame error. Once
    # aligned, project away only acceleration that pushes either near-envelope
    # joint rate farther outward. Acceleration that reverses a joint is exactly
    # unchanged, retaining the traveling-bend carrier rather than rescaling it.
