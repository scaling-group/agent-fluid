...
function target_policy(state, params)
    ...
    # Let the persistent target estimate own mean route curvature. The faster
    # current-bearing path below is reserved for posterior half-cycle release.
    ...
    # half-cycle. Current body-frame bearing lets this high-authority path
    # release immediately instead of inheriting the route estimator's lag.
