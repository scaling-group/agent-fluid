...
function target_policy(state, params)
    ...
    # diverging error retains the evaluated parent's full route memory.
    ...
    # from current target geometry. Release only this lagged route component;
    # the carrier and auxiliary posterior half-cycle retain full authority.
