# Phase-balanced terminal energy with response-driven posterior wave phase.
...
function target_policy(state, params)
    ...
    # Regulate activity about the moving C-turn equilibrium without moving the
    # equilibrium itself. Velocity-odd feedback adds energy on both measured
    # half-cycles and releases as the phase-plane radius recovers.
    ...
    # Amplitude retention alone leaves the best inherited pass tangential.
    # Ask for target-ray rotation plus course closure, compare that request
    # with measured yaw, and place only the missing response in posterior wave
    # phase. Measured anterior velocity supplies the half-cycle coordinate.
