# Phase-balanced terminal energy at both joints of the lagged traveling wave.
...
function target_policy(state, params)
    ...
    # moving lag target is low, add bounded acceleration parallel to measured
    # velocity on both half-cycles. This changes rhythm stability, not mean
    # curvature or prescribed phase; the lag target still organizes propagation.
    ...
    posterior_energy_weight = target_behind_weight^2 *
        terminal_response_weight * posterior_low_activity_weight
