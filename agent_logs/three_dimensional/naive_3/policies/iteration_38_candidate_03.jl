# Phase-balanced terminal energy with response-gated anterior C-turn reserve.
...
function target_policy_params()
    return (
        ...
        maximum_terminal_response_acceleration=2.0,
...
function target_policy(state, params)
    ...
    # A terminal C-turn must remain actionable even at the parked bend that
    # defeated velocity-odd phase and energy residuals. Ask for the target-ray
    # angular rate plus bounded course closure, compare it with measured yaw,
    # and release the direct response as soon as the requested turn develops.
    ...
    terminal_turn_response =
        params.maximum_terminal_response_acceleration *
    ...
    # Preserve the evidenced approach phase modulation without the completed
    # harmful terminal posterior-phase residual.
