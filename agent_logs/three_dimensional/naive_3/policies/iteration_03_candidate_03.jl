# Full-direction posterior gating around the evidenced bounded-curvature carrier.
# Oscillation phase remains in measured joint state; target direction comes
# only from normalized body-frame geometry.
