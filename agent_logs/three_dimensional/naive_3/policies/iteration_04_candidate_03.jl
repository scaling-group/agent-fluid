# Closing-response-gated redirect around the evidenced posterior-gated carrier.
# Target geometry and translational response are normalized and body-relative;
...
function target_policy(state, params)
    ...
    # redirect curvature is recruited only when large direction error combines
    # with inadequate closing response. Productive far-field closing therefore
    # retains the evidenced 7-degree carrier without a clock or hidden mode.
