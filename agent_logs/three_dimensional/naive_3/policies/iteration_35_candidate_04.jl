# Terminal posterior phase response around the course-hold C-turn scaffold.
...
function target_policy(state, params)
    ...
    # Matching the target-ray rate alone preserves a tangential orbit. Ask for
    # a bounded additional course-closing turn, compare it with measured yaw,
    # and translate only the missing response into posterior wave phase. The
    # joint-velocity product is invariant under lateral reflection and changes
    # no anterior energy or static joint equilibrium.
