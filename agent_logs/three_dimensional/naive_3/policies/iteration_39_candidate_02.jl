# Phase-balanced terminal wave energy around the course-hold C-turn scaffold.
...
function target_policy(state, params)
    ...
    # completed signed half-cycle pulse collapsed into a parked bend because
    # its work vanished quadratically near zero speed and biased one half of
    # the rhythm. Instead, measure phase-plane activity about the commanded
    # equilibrium and add odd velocity feedback on both half-cycles only when
    # that activity is low. This changes the local damping stability without
    # adding mean curvature or a preferred lateral sign.
