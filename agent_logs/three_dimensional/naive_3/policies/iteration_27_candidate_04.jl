# Terminal turn-response burst around the evidenced course-hold C-turn.
...
function target_policy(state, params)
    ...
    # transient turn-response deficit. Add an anterior-only C-bend and release
    # it continuously as useful yaw develops; posterior steering is unchanged.
    ...
    burst_weight = terminal_response_weight * large_course_error_weight *
    ...
    # while the established terminal hold and traveling wave remain active.
    ...
    # terminal-hold equilibrium; the new response-deficit burst is anterior-only.
