...
- Treat measured yaw as a gait-half-cycle selector, not a slow course estimate,
  ...
  rear selector. Any later gait-recovery test must leave the evidenced
  steering equilibria and far carrier fixed and add alternating rather than
  one-sided stroke energy; reject it if the quiet bend persists, the first
  recovery changes, the anterior-to-posterior traveling wave degrades,
  clamp/load residence rises, or near-target and final-distance statistics do
  not improve.
