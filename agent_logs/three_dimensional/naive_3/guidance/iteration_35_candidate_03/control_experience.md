...
- Treat measured yaw as a gait-half-cycle selector, not a slow course estimate,
  ...
  scaffold; a later steering asymmetry is applicable only as a bounded
  modulation of that active carrier. Falsify this transfer if the first
  return changes, phase activity still collapses, the wake or orbit broadens,
  clamp/load residence rises, or closest approach, near-target residence, and
  final distance do not improve together.
