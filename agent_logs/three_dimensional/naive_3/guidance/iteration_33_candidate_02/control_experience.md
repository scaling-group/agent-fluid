...
- Treat measured yaw as a gait-half-cycle selector, not a slow course estimate,
  ...
  low-activity kick, or half-cycle gain. If this scaffold is revisited, test a
  genuinely symmetric activity-regulation mechanism that reinforces both
  measured velocity half-cycles without moving either equilibrium; reject it
  if the ahead-side return changes, phase-plane activity still collapses,
  speed/wake curvature enlarges the orbit, clamp/load residence rises, or
  near-target and distance statistics do not improve.
