...
- Treat measured yaw as a gait-half-cycle selector, not a slow course estimate,
  ...
  weak requested-sign yaw, and command reserve coexist; reject it if the first
  pass changes, wake coherence or propulsion degrades, clamp/load residence
  rises, or near-target residence and distance statistics do not improve.
