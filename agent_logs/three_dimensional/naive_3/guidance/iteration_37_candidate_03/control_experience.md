...
- Treat measured yaw as a gait-half-cycle selector, not a slow course estimate,
  ...
  either response gate. A genuinely different posterior-role test must
  directly preserve measured posterior rhythmic activity without shifting
  mean bend or suppressing the symmetric anterior carrier, and is falsified
  by another low-activity minimum or failure to beat the `1.175L` near-target
  residence.
