...
# predictive common-carrier barrier protects the two-joint traveling wave.

function target_policy_params()
    return (
        version="dogfish3d_predictive_carrier_rate_barrier_v1",
        control_period=0.55,
...
function target_policy(state, params)
    ...
    # the observed gait phase. The most restrictive admissible carrier scale
    # is applied to both joints, preserving their traveling-wave relationship.
    # Steering keeps priority, and inward carrier work remains unattenuated.
