# Compact L64 target controller: retain response-released reversal while far,
# then restore redirect-priority carrier coupling through the approach.

function target_policy_params()
    return (
        version="dogfish3d_approach_restored_carrier_coupling_v1",
        control_period=0.55,
