...
# allocate its useful half-cycle through bounded posterior lag modulation.

function target_policy_params()
    return (
        version="dogfish3d_turn_phase_posterior_lag_v1",
        control_period=0.55,
...
function target_policy(state, params)
    ...
    # Translate that same useful/return-stroke observation into posterior wave
    # shape. The modulation is symmetric about the evaluated mean lag, so it
    # reallocates bend timing rather than adding static curvature or raw drive.
