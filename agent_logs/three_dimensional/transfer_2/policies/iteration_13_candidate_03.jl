# Compact L64 target controller: preserve continuous posterior LOS steering
# while releasing transient anterior redirect inside an observed intercept.

function target_policy_params()
    return (
        version="dogfish3d_intercept_corridor_anterior_release_v1",
        control_period=0.55,
