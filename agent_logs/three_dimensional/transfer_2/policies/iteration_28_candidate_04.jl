...
# positive-work decomposition protects reversal of the traveling carrier.

function target_policy_params()
    return (
        version="dogfish3d_positive_work_carrier_decomposition_v1",
        control_period=0.55,
...
function target_policy(state, params)
    ...
    # Apply one bounded scale only to energy-injecting carrier components.
    # Negative-work reversal and target-conditioned steering pass unchanged,
    # so one joint cannot weaken the other's reversal through a common scale.
