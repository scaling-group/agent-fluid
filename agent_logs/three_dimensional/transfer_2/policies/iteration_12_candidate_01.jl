...
# scaffold and make its intercept geometry aware of projected miss distance.

function target_policy_params()
    return (
        version="dogfish3d_range_aware_intercept_redirect_v1",
        control_period=0.55,
...
function target_policy(state, params)
    ...
    # Blend its angular error with projected cross-track miss: the same course
    # angle merits earlier correction at range and less residual correction
    # near capture. Both terms are bounded body-frame geometry.
