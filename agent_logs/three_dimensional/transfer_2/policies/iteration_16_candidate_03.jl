...
# allocate its useful half-cycle through bounded posterior amplitude shaping.

function target_policy_params()
    return (
        version="dogfish3d_turn_phase_posterior_amplitude_v1",
        control_period=0.55,
...
function target_policy(state, params)
    ...
    # amplitude. The modulation is symmetric about the evaluated carrier, so
    # it reallocates the existing bend without changing base lag or adding a
    # static curvature bias.
