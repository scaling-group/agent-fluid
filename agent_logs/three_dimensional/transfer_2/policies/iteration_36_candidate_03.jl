...
# state-derived preview withdraws positive carrier work before rate contact.

function target_policy_params()
    return (
        version="dogfish3d_predictive_positive_work_guard_v1",
        control_period=0.55,
...
function target_policy(state, params)
    ...
    # This is a short normalized phase-space preview, not a lower scalar onset:
    # only bounded positive-work carrier acceleration advances the projected
    # rate, while reversal and target-conditioned steering stay outside it.
    ...
    # The evaluated release is useful while far, but restoring phase-coupled
    # reversal over the existing approach handoff shortens the late arc.
    reversal_release =
        (1.0 - distance_wave_weight) *
