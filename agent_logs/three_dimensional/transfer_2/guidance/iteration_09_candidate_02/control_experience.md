...
- Pair the distance/closing steering-headroom allocator with a velocity-course
  ...
  (`20.653T`, `157.174 L*T`), whereas observed line-of-sight lead was a smaller
  independently positive mechanism (`20.471T`, `156.422 L*T`). Preserve the
  half-cycle scaffold; test LOS lead only as a bounded, closing-gated companion
  and reject the combination if arrival/integral, capture, wake coherence,
  joint/command residence, force, or moment regress.
