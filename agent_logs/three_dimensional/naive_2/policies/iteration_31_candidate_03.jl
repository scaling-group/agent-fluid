# Unified predicted-miss handoff with a posterior course residual.
# Large closing misses recruit bounded tail-only rhythmic authority without
# replacing the shared redirect that already preserves centered captures.
...
function target_policy(state, params)
    ...
    # this tail-only residual vanish rapidly on centered courses, while its
    # sign and magnitude remain smooth and reflection equivariant. It cannot
    # alter the far-field carrier or enlarge the common steering channel.
