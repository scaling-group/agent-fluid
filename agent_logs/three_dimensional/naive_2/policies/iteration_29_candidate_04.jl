# Predicted-miss curvature with a unified response-and-geometry handoff.
# Both rhythmic redirects remain active until measured yaw is corrective and
# the predicted body-frame course is already centered on the target.
