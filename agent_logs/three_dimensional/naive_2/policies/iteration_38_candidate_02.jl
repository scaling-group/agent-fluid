# Unified predicted-miss handoff with approach-scheduled phase-space reserve.
# Near-target geometry smoothly activates joint-motion look-ahead without
# changing the earlier directional allocator or propulsive carrier.
...
function target_policy(state, params)
    ...
    # near-target gate engages, projection vanishes and the faster sampled
    # directional allocator remains unchanged. The direct rate guard remains
