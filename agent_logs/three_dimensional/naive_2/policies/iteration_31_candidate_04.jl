# Unified predicted-miss handoff with carrier-separated force response.
# Wrong-side residual lateral force re-engages only the rhythmic authority
# already released from a closing terminal intercept.
