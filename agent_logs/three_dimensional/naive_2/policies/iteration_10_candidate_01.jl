# Closing-speed interception hold on a course-residual traveling bend.
# Far-field course feedback preserves translation; a near, closing, off-course
# approach blends continuously into a damped target-bearing curvature posture.
...
function target_policy(state, params)
    ...
    # The hold keeps target-signed curvature authority while replacing part of
    # the propulsive beat with a slower critically damped two-joint posture.
