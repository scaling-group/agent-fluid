# Predicted-miss curvature with a response-released posterior redirect.
# Body-frame interception recruits a persistent mean bend; the mid-stroke
# posterior pulse fades once carrier-separated yaw is already corrective.
