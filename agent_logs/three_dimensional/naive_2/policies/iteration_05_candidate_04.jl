# State-feedback traveling bend with phase-compensated approach redirects.
# Joint state carries propulsive phase; full body-frame target geometry trades
# symmetric drive for retained half-cycle steering only during a near misalign.
...
function target_policy(state, params)
    ...
    # retaining signed half-cycle steering.  This creates a reversible burst
    # redirect rather than a persistent curvature or general rate brake.  A
    # recovered alignment restores the evidenced cruise carrier continuously.
