# Predicted-miss curvature with geometry-qualified posterior-pulse release.
# Body-frame interception retains the mid-stroke redirect until measured yaw
# is corrective and the predicted course is already centered on the target.
