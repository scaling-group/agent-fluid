...
- Use carrier-separated corrective response and residual predicted miss
  ...
  translation and should next be tested through a different rhythmic actuator
  such as posterior phase-lag shaping. Inherited identical-controller repeats
  still expose `1.2164L` and `1.0117L` left-exit misses, while angle-domain
