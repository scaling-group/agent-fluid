...
- Treat rapid target-line rotation as a tangential-margin diagnostic, not a
  ...
  while terminal margin and actuator quality worsen. Test a distinct bounded
  authority-release mechanism on the shared handoff, and retain it only if
  capture and course margin improve together with route, wake, joint reserve,
  and the lower load class intact.
