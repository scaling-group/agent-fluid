...
- Use carrier-separated corrective response and residual predicted miss
  ...
  mechanism. Preserve the shared geometry/response handoff and evidenced
  carrier, but test a distinct bounded rhythmic actuator such as half-cycle
  timing, and retain it only if capture and terminal-course spread improve
