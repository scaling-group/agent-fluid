...
- Preserve body-frame constant-course predicted miss as a useful direct-route
  ...
  `1.01564L`, `1.12140L`, and `1.21644L` before exiting left. The no-pulse
  sibling also captured at `16.011T`, so neither byte identity nor the
  posterior pulse explains reliable success. Preserve the normalized
  time-to-closest/signed-miss gate, small bounded carrier mean, and
  measured-response handoff, but avoid more pulse or static-bend gain tuning.
