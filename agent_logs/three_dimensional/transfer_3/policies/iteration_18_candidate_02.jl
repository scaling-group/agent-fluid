# Phase-2 candidate: keep the completed LOS-rate distributed C-bend and add a
# bounded yaw-response-reversing asymmetry to the posterior traveling wave.

function target_policy_params()
    return (
        version="dogfish3d_response_reversing_halfcycle_tail_v1",
        control_period=0.55,
