# Phase-2 candidate: preserve the response-reversing half-cycle route and
# recruit posterior phase steering only under persistent same-side actuator stress.

function target_policy_params()
    return (
        version="dogfish3d_actuator_consistent_tail_phase_v1",
        control_period=0.55,
