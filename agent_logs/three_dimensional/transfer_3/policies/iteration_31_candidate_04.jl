...
# recruit it only against opposing moment left after joint-phase demodulation.

function target_policy_params()
    return (
        version="dogfish3d_one_sided_demodulated_moment_residual_v1",
        control_period=0.55,
...
function target_policy(state, params)
    ...
    # while a helping residual leaves the actuator-consistent baseline intact.
    # The product of the odd response direction and odd residual is reflection
    # invariant, as is clamping that product to its opposing half-space.
