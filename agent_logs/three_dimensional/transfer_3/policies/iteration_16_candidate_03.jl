# Phase-2 candidate: keep the completed LOS-rate distributed C-bend and make
# its returned two-joint command explicit at the physical acceleration bound.

function target_policy_params()
    return (
        version="dogfish3d_los_response_triggered_cbend_accel_feasible_v2",
        control_period=0.55,
