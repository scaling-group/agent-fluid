# Phase-2 candidate: line-of-sight-rate release on the coherent state-feedback
# carrier. Normalized body-frame target geometry supplies the redirect while
# rigid-body route response brakes it before delayed heading alignment.

function target_policy_params()
    return (
        version="dogfish3d_los_rate_release_v1",
        control_period=0.55,
