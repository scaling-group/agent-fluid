# Phase-2 candidate: keep the coherent LOS-rate traveling bend and sustain its
# distributed C-bend while bounded route-response demand remains large.

function target_policy_params()
    return (
        version="dogfish3d_los_response_triggered_cbend_v1",
        control_period=0.55,
