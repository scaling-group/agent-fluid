# Phase-2 candidate: preserve the coherent LOS-rate traveling bend and sustain
# its distributed C-bend while bounded route-response demand remains large.

function target_policy_params()
    return (
        version="dogfish3d_evidence_selected_los_response_cbend_v2",
        control_period=0.55,
...
function target_guidance(state, qd1, qd2, params)
    ...
    # Both observed-demand paths release continuously.
