...
- Actuator-envelope cleanup must be separated from carrier weakening. A
  ...
  `0.536U`. This does not yet establish a load or route advantage:
  `0.01333/0.00694` force/moment RMS overlaps the exact-route spread, and
  joint-rate-limit residence is unchanged. In contrast, the assigned
  ...
  mechanism. Falsify anti-windup as reusable if a repeat loses capture,
