...
- Carrier-demodulated hydrodynamic response has a replicated effort benefit,
  ...
  raises velocity-limit occupancy to `8.10%`. Preserve the LOS C-bend,
  traveling carrier, persistent phase path, and carrier subtraction. Replicate
  one-sided opposing-response recruitment before changing it, and avoid
  scalar-tuning raw response, yaw-closure relief, or velocity-headroom gates.
