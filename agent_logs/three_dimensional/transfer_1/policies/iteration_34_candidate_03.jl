...
# add a terminal progress-loss veto to steering release. The traveling bend,
# steering ceiling, and spatial allocation stay unchanged. No clock, world
# coordinate, route, or mutable phase is used.

function target_policy_params()
    return (
        version="dogfish3d_progress_loss_release_veto_v1",
        drive_period=0.55,
        control_period=0.55,
        ...
        recovery_closing_speed_start=0.00,
        recovery_closing_speed_full=-0.16,
...
function target_policy(state, params)
    ...
    # Keep the evaluated intercept veto, steering ceiling, carrier reserve,
    # and spatial allocation. Only after terminal progress has reversed does
    # the new gate veto response-based steering release; it is identically
    # inactive throughout the positive-closing sampled capture approaches.
