...
# propulsive traveling bend, then preserve steering reserve by softening only
# outward carrier effort already saturating near the joint-speed envelope. No
# clock, world coordinate, route, or mutable phase is used.

function target_policy_params()
    return (
        version="dogfish3d_intercept_guarded_speed_reserve_v1",
        drive_period=0.55,
        control_period=0.55,
