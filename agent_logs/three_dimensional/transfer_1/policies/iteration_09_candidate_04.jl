...
# target/velocity geometry shows a growing line-of-sight miss. The carrier is
# never attenuated. No clock, world coordinate, route, or mutable phase is used.

function target_policy_params()
    return (
        version="dogfish3d_course_servo_los_guarded_release_v1",
        drive_period=0.55,
        control_period=0.55,
...
function turn_response_module(state, guidance, drive, params)
    ...
    # line-of-sight geometry does not show a growing miss.
...
function target_policy(state, params)
    ...
    # geometry shows the line of sight rotating in the corrective direction.
    # Then smoothly restore the existing course steering; never add gain,
    # reverse the request, or alter either half of the propulsive carrier.
