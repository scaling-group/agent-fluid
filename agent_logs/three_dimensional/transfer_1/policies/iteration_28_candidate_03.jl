...
# transfer unsafe-terminal additive steering from the posterior propulsive
# joint toward the anterior steering joint. Total steering authority stays
# constant. No clock, world coordinate, route, or mutable phase is used.

function target_policy_params()
    return (
        version="dogfish3d_unsafe_intercept_anterior_transfer_v1",
        drive_period=0.55,
        control_period=0.55,
...
function target_policy(state, params)
    ...
    # bounded share of the terminal steering residual anteriorly so posterior
    # lag remains primarily propulsive. The share sum is invariant.
