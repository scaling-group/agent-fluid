...
# Target geometry owns turn sign and common amplitude relief; observed
# displacement phase modulates curvature without a clock or a second envelope.
...
function target_policy(state, params)
    ...
    # Apply only common geometry-owned relief.  The matched ablation removes
    # the second phase-dependent envelope while retaining target-signed
    # half-cycle curvature and the posterior-lagged carrier.
