...
# lane. Target geometry owns turn sign; measured lateral motion and yaw response
# modulate bend magnitude without changing the propulsive carrier.
...
function target_policy(state, params)
    ...
    # The episode already applies this exact projection before joint
    # integration. Owning it at the policy interface bounds public commands
    # without the phase distortion of the failed joint-rate tapers.
