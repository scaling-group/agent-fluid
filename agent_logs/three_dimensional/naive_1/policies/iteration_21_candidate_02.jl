...
# Target geometry owns turn sign and common gait relief; observed displacement
# phase redistributes bounded mean curvature without a clock.
...
function target_policy(state, params)
    ...
    # shares while mildly reducing the common rhythmic amplitude. Full cruise
    # amplitude returns continuously as the target returns to the body axis.
