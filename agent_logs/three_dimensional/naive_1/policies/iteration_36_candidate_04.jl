# Geometry-scheduled half-cycle policy for the moving-window lane.
# Target geometry owns turn sign and the common propulsion envelope; observed
# displacement phase modulates steering without also reallocating drive.
...
function target_policy(state, params)
    ...
    # Keep propulsion allocation on the slow target-geometry channel. Joint
    # displacement already schedules steering above; allowing it to also
    # redistribute the drive envelope produced a contradictory near-miss
    # topology in inherited executable-equivalent evidence.
