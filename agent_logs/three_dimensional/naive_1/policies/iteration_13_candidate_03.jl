...
# Target geometry owns turn sign and the gait envelope; observed displacement
...
function target_policy(state, params)
    ...
    # Preserve absolute curvature while mildly reducing rhythmic drive when
    # the target is far off the body axis. Full cruise returns with alignment.
