# Half-cycle-steered differential-curvature redirect for the moving-window
# lane. Body-frame target geometry owns the turn request; observed joint phase
# redistributes bounded curvature without changing the propulsive carrier.
...
function target_policy(state, params)
    ...
    # A normalized body-frame direction cosine supplies a persistent route
    # request. It carries no world direction, distance stage, or rate servo.
