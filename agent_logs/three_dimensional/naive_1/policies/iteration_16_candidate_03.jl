# Coordinated-projection redirect/cruise policy for the moving-window lane.
# Target geometry owns turn sign; a shared acceleration projection preserves
# the two-joint command direction at the actuator boundary.
...
function target_policy(state, params)
    ...
    # Enforce the same hard acceleration envelope with one positive scale for
    # the paired command. Unlike independent clipping, this ray projection
    # preserves the instantaneous anterior/posterior drive ratio and sign.
    ...
    a1 = acceleration_scale * raw_a1
    a2 = acceleration_scale * raw_a2
