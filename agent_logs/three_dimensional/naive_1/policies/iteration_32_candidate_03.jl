# Geometry-scheduled envelope policy for the moving-window lane.
# Target geometry owns turn sign and common relief; observed displacement phase
# biases steering while leaving the propulsive envelope independent of phase.
...
function target_policy(state, params)
    ...
    # Keep the propulsion envelope a common function of target geometry. The
    # inherited phase redistribution improved some distance integrals but also
    # produced repeated left-exit misses; phase therefore remains confined to
    # steering and cannot reshape the oscillator amplitude here.
