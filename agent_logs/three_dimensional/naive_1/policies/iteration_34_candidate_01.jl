...
# Target geometry owns turn sign and common amplitude relief; observed joint
# displacement modulates steering without redistributing the propulsive wave.
...
function target_policy(state, params)
    ...
    # preserves the evidenced carrier/steering allocation while cleanly
    # ablating the semantically inconsistent envelope redistribution.
