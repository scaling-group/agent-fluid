# Broadside-reserve envelope-redistribution policy for the moving-window lane.
# Target geometry owns turn sign and bounded recovery curvature; observed
# displacement phase redistributes rhythmic effort without a clock.
...
function target_policy(state, params)
    ...
    # Once target direction becomes broadside, route_request is already near
    # saturation.  Add a smooth bounded reserve to the mean-curvature layer,
    # where it can increase redirect authority without altering the zero-mean
    # traveling wave.  The response gate still releases correcting yaw.
