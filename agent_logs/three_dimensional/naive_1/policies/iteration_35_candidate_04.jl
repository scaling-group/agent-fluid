...
function target_policy(state, params)
    ...
    # Preserve the geometry-owned mean relief, but redistribute it between
    # observed displacement half-cycles. The target-aligned half gets less
    # relief and the opposed half gets more, without changing curvature shares
    # or the posterior lag and without introducing a clock.
