# Response-coupled redirect/cruise policy for the moving-window lane.
# Target geometry owns turn sign; useful yaw response releases both curvature
# and gait relief without a clock, velocity-led phase, or extra route servo.
