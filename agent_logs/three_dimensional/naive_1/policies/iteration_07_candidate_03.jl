# Envelope-projected terminal lateral-velocity redirect for the moving-window
# lane. Target geometry owns turn sign; body-frame lateral motion and measured
# yaw response modulate bend magnitude without changing the propulsive carrier.
...
function target_policy(state, params)
    ...
    # Match the episode's physical acceleration projection at the public
    # policy boundary. This cannot change the acceleration applied downstream,
    # but it prevents the controller from returning unrealizable demand.
