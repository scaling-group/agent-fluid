...
# strengthens useful steering without reallocating the propulsive envelope.
...
function target_policy(state, params)
    ...
    # Keep common propulsion relief owned only by target geometry. Observed
    # phase acts through the positive steering factor above, so it cannot also
    # reallocate the drive envelope between beat halves.
