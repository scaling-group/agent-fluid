# Phase-separated envelope-redistribution policy for the moving-window lane.
# Target geometry owns mean curvature; observed displacement phase allocates
# only the common rhythmic envelope, without a clock.
...
function target_policy(state, params)
    ...
    # Keep persistent route curvature independent of beat phase. Earlier
    # displacement-phase curvature steering was capture-class but had a worse
    # distance integral than the geometry carrier; phase is retained below
    # only to allocate the common rhythmic envelope.
