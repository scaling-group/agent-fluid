...
# Target geometry owns turn sign and mean relief; a smooth reserve adds
# redirect authority while observed displacement redistributes rhythmic effort.
...
function target_policy(state, params)
    ...
    # Preserve the geometry-owned mean relief while redistributing it across
    # the observed beat: the target-aligned half gets less relief and the
    # opposed half gets more. This leaves the curvature reserve, posterior lag,
    # and clock-free traveling-wave structure intact.
