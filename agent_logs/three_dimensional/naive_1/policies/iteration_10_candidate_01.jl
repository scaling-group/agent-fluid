# Half-cycle-steered terminal lateral-velocity redirect for the moving-window
# lane. Target geometry owns turn sign; observed joint phase redistributes
# bounded curvature without changing the propulsive carrier or its envelope.
...
function target_policy(state, params)
    ...
    # side releases some curvature and adverse lateral motion restores it. The
    # bounded velocity lead cannot invert a target-side request.
