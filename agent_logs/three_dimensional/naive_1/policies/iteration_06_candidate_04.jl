# Terminal lateral-velocity-lead redirect for the moving-window lane.
# Target geometry owns turn sign.  Body-frame lateral motion and measured yaw
# response modulate bend magnitude without changing the propulsive carrier.
