# Progress-qualified differential-curvature redirect for the moving-window lane.
# Target geometry owns turn sign. Curvature release requires both correcting
# yaw and improving body-frame target bearing.
...
function target_policy(state, params)
    ...
    # Correct-sign yaw is useful only when the body-frame line of sight also
    # moves toward center. Qualifying release by both response measures keeps
    # slip or beat-scale yaw from weakening the persistent route request.
    turn_rate = clamp(
