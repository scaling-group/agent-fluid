# Broadside reserve plus common-envelope redistribution policy.
# Target geometry owns turn sign; observed displacement phase redistributes
# the rhythmic envelope while a separate gate acts before an overshoot.
...
function target_policy(state, params)
    ...
    # relief and the opposed half gets more. This changes neither the
    # broadside reserve nor the anterior/posterior mean-curvature shares.
