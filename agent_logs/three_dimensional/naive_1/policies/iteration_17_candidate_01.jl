...
# Persistent target geometry owns turn sign and the gait envelope; useful yaw
...
function target_policy(state, params)
    ...
    # envelope while preserving absolute curvature shares. Keep this slow
    # geometry schedule independent of fast yaw response: the completed
    # response-coupled variant stayed inside duplicate rollout variation.
