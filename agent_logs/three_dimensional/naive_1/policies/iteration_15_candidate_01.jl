# Geometry-scheduled redirect/cruise policy for the moving-window lane.
# Target geometry owns turn sign and the whole gait envelope; useful yaw
# response releases curvature without changing beat phase or posterior lag.
