# Evidence-recovered differential-curvature redirect for the moving-window lane.
# Normalized target geometry owns turn sign. Measured yaw may release part of
# the bend, while final commands remain inside the physical acceleration limit.
...
function target_policy(state, params)
    ...
    # Persistent target side owns the route sign. Completed evidence rejects
    # both body-lateral and target-line terminal velocity residuals here.
    ...
    # Match the episode's existing projection at the policy boundary. This
    # removes unrealizable public demand without adding rate-dependent phase
    # shaping, which completed evidence shows can destroy the captured route.
