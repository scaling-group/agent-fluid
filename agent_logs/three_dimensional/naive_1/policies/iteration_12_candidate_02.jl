# Geometry-signed half-cycle redirect for the moving-window lane. Target
# geometry is the sole route signal; observed joint phase redistributes bounded
# curvature without changing the propulsive carrier or its hard envelope.
...
function target_policy(state, params)
    ...
    # No instantaneous velocity or yaw response can qualify or invert it.
    ...
    base_head_bias = -params.head_bias_limit * route_request
    base_tail_bias = params.tail_bias_limit * route_request
