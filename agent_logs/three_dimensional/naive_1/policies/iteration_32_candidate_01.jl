...
# strengthens the useful steering half without reallocating the drive envelope.
...
function target_policy(state, params)
    ...
    # Keep the geometry-owned common relief independent of beat phase. Two
    # executable-equivalent redistribution misses motivate this ablation;
    # observed phase still acts through the positive steering factor above.
