# Geometry-scheduled half-cycle steering policy for the moving-window lane.
# Target geometry owns turn sign and the common gait envelope; observed
# displacement phase changes steering share without modulating propulsion.
...
function target_policy(state, params)
    ...
    # Keep propulsion allocation independent of observed beat side. When
    # lateral target error is large, mildly reduce the common rhythmic
    # envelope so differential mean curvature retains redirect authority;
    # full cruise amplitude returns continuously as alignment improves.
