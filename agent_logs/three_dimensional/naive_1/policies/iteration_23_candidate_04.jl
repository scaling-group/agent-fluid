# Broadside-reserve redistribution policy for the moving-window lane.
...
function target_policy(state, params)
    ...
    # themselves so authority appears before overshoot. The response gate can
    # still release this reserve when yaw is correcting toward the target.
