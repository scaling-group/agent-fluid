# Common-envelope geometry-scheduled policy for the moving-window lane.
# Target geometry owns turn sign and rhythmic relief; observed displacement
# phase redistributes curvature without perturbing the propulsion envelope.
...
function target_policy(state, params)
    ...
    # Use one common geometry-scheduled envelope across both half-cycles.
    # This preserves the sampled carrier while the separate displacement-only
    # phase term above allocates curvature, not propulsive amplitude.
