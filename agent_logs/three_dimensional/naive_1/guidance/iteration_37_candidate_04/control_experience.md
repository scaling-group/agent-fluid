...
- Common-envelope half-cycle redistribution has a repeatable capture and
  ...
  `0.03171/0.01632` and `0.03259/0.01656`. A future demand-relief test should
  therefore change the saturation mechanism separately and preserve the
  instantaneous two-joint ratio; accept a coupled allocator only if capture,
  both wake rows, and the current route band survive and rate contact or loads
  improve materially.
