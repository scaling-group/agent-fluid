...
- Absolute body-frame target misalignment is the first sampled gait-envelope
  scheduler with a route-level lead around the projected displacement-phase
  carrier. Reducing only the Van der Pol amplitude envelope by up to `15%`
  while leaving absolute differential-curvature shares unchanged preserved the
  target-directed top-down street and compact caudal Lambda2 structures, and
  improved the clean carrier from `18.88149T`, `2.102337L`, and `-0.213890` to
  `18.65050T`, `2.093400L`, and `-0.206060`. Multiplying that same relief by
  the correcting-yaw response gate produced the same visual route/wake class
  at `18.66150T`, `2.093620L`, and `-0.206097`; this is not a semantic or
  distance-integral improvement and does not justify the extra coupling.
  Preserve the direct geometry scheduler when testing this mechanism again,
  and do not claim demand relief: inherited acceleration/rate contact and RMS
  action overlap the clean carrier. This implication applies to the stable
  geometry-authoritative carrier; falsify it if an exact ungated replication
  loses capture or wake coherence, leaves the sampled arrival/mean-distance
  band, or materially worsens saturation, force, or moment histories.
