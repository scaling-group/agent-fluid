...
- Terminal feedback must preserve target-side authority as well as the carrier.
  ...
  instantaneous course projection. Test a slower or joint-phase-qualified
  release as a separate mechanism, and falsify it first on repeated capture,
  route class, and wake coherence before interpreting timing or actuation
  changes.
