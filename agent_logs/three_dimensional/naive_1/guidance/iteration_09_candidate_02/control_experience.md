...
- Instantaneous terminal velocity residuals are not established improvements
  ...
  this capture class. If the same route persists, test one phase-preserving
  actuator primitive such as bounded target-side half-cycle steering, while
  retaining the projected envelope and static curvature sign; falsify it on
  capture, route/load improvement beyond the `19.019--19.228T` and
  `2.1154--2.1259L` sampled band, saturation, and both wake views.
