...
- Common-envelope half-cycle redistribution has a repeatable distance-integral
  ...
  (`0.01537/0.02894`, `0.01656`) establish no demand relief. Treat this as
  evidence that removing redistribution is capture-compatible, not proof of
  robustness; independent replication must still distinguish its consistent
  semantic class from redistribution's two rare misses. Avoid another
