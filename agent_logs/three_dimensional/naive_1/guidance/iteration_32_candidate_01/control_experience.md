...
- Common-envelope half-cycle redistribution has a repeatable distance-integral
  ...
  the next robustness discriminator; its three completed captures at
  `18.6505--18.7550T` and `2.09340--2.09542L` give the applicability band, but
  do not claim the unevaluated ablation as proven improvement. Avoid another
