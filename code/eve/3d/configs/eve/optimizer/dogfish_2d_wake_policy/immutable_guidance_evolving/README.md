# Dogfish 2D Multi-Wake Target Worker
...
Produce one improved fixed-morphology policy that drives the fish diagonally
through the current four-cylinder asymmetric staggered wake field to the target.
...
edit morphology, WaterLily, the episode, geometry, or scoring code.
...
`solver/cases/dogfish_2d_shape_policy/candidate_target_policy.jl` must exist
