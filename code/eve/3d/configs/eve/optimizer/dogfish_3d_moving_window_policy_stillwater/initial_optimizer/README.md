...
This is the three-dimensional, still-water continuation of the August-5
...
- The June-13 continuous superellipse body and physical caudal fan are used.
...
Its executable control expressions are the same as the August-5 2D seed; only
